class Start {
    ...
    matchResult() {
        if(this.winner != "SERI") {
            ...
            return `WAHHH ${this.winner}, GAK ADA YANG MENANG 😜`
        }
    }
...
function pickOption(params) {
    ...
    // console.log("bot pilih", start.getBotOption)
    // console.log("player pilih", start.getPlayerOption) /*bebas mau pake get apa ga sama aja karena diatas sudah pake set */
